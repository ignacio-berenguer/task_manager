...
TABLA_DESCRIPCIONES = {
    "tareas": "Tabla principal de tareas. Contiene tarea_id (entero auto-incremental, PK), tarea (descripcion breve), responsable, descripcion (detalle), fecha_siguiente_accion, tema, estado.",
    "acciones_realizadas": "Acciones realizadas sobre las tareas. Relacionada con tarea_id (entero, FK). Contiene accion (texto de la accion) y estado.",
