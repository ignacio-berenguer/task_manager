...
const buttonVariants = {
  variant: {
    default: 'bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_15px_-3px_hsl(var(--color-primary)/0.4)]',
    ...
    return (
      <button
        className={cn(
          ...
          'ring-offset-background transition-all duration-150 active:scale-[0.98]',
