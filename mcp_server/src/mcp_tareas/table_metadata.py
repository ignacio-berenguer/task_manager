...
TABLA_DESCRIPCIONES = {
    "tareas": "Tabla principal de tareas. Campos: tarea_id, tarea, responsable, descripcion, fecha_siguiente_accion, tema, estado.",
    "acciones_realizadas": "Acciones realizadas sobre las tareas. Campos: id, tarea_id, accion, estado.",
